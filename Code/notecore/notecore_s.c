...
extern const RPC_DISPATCH_TABLE ICoreNotify_v0_0_DispatchTable;

static const RPC_SERVER_INTERFACE ICoreNotify___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x956003E7,0x3C5A,0x42EB,{0xBA,0x19,0xD8,0xEE,0xF5,0x4D,0xAB,0xFF}},{0,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&ICoreNotify_v0_0_DispatchTable,
    0,
    0,
    0,
...
RPC_IF_HANDLE ICoreNotify_v0_0_s_ifspec = (RPC_IF_HANDLE)& ICoreNotify___RpcServerInterface;
...
static const MIDL_STUB_DESC ICoreNotify_StubDesc = 
    {
    (void *)& ICoreNotify___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION ICoreNotify_table[] =
    {
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE ICoreNotify_v0_0_DispatchTable = 
    {
    1,
    (RPC_DISPATCH_FUNCTION*)ICoreNotify_table
    };

static const SERVER_ROUTINE ICoreNotify_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)onCoreNotify
    };

static const MIDL_SERVER_INFO ICoreNotify_ServerInfo = 
    {
    &ICoreNotify_StubDesc,
    ICoreNotify_ServerRoutineTable,
    notecore__MIDL_ProcFormatString.Format,
    ICoreNotify_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
